...
func run(binary, arch, version, rev, fw, spkDir, envExample, out string) error {
	...
	files := []tarFile{
		...
		// Wizard generators (exonerated: v0.1.7 with these files
		// installed fine once the broken v0.1.3 residue was removed —
		// the feasibility failures tracked the residue, not the files).
