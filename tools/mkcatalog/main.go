...
func run(pattern, assets, out string) error {
	...
	for _, f := range files {
		...
		pkgs = append(pkgs, map[string]any{
			...
			"md5":              m["md5"],
			"size":             m["size"],
			"changelog":        "See https://github.com/moToroTor/wankarr/releases",
			"distributor":      "moToroTor",
			"distributor_url":  "https://github.com/moToroTor/wankarr",
			"maintainer":       "moToroTor",
			"maintainer_url":   "https://github.com/moToroTor/wankarr",
		})
	}
